...
func on_card_played():
	...
	if played==false:
		...
		elif (check_for_straight(lst_card)!=null and children_slots_right[0].combi==null) or (check_for_straight(lst_card)!=null and children_slots_right[0].combi=="straight"):
			print("straight")
